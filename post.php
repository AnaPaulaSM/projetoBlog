<?php
  include_once("../Projeto_Blog/templates/header.php");
  ...
  <main id="post-container">
    <div class="content-container">
      ...
      <div class="img-container">
        <img src="<?= $BASE_URL ?>../Projeto_Blog/img/<?= $currentPost['img'] ?>" alt="<?= $currentPost['title'] ?>">
      </div>
...
<?php
  include_once("../Projeto_Blog/templates/footer.php")
?>